...
import frc.robot.util.tunable.PIDConstantsTunable;
...
public final class Constants {
    ...
    public static class Indexer {
        ...
        public static final FlywheelConstantsTunable spindexerConstants =
            new FlywheelConstantsTunable("SpindexerConstants",
        ...
        public static final FlywheelConstantsTunable magazineConstants =
            new FlywheelConstantsTunable("MagazineConstants",
    ...
    public static final class AdjustableHood {
        ...
        // @formatter:off
        public static final PIDConstantsTunable pid =
            new PIDConstantsTunable("AdjustableHoodPID", new PIDConstantsBuilder(GravityTypeValue.Arm_Cosine)
                .kP(200.0)
                .kI(0.0)
                .kD(0.0)
                .kV(0.0)
    ...
    public static final class Turret {
        ...
        // @formatter:off
        public static final PIDConstantsTunable pid =
            new PIDConstantsTunable("TurretPID", new PIDConstantsBuilder(GravityTypeValue.Elevator_Static)
                .kP(48.0)
                .kI(0.0)
                .kD(0.0)
                .kV(3.6)
    ...
    public static final class Shooter {
        ...
        public static final FlywheelConstantsTunable constants =
            new FlywheelConstantsTunable("ShooterConstants", new FlywheelConstantsBuilder()
                .holdCurrent(40.0)
                .maxDutyCycle(1.0)
                .isReversed(true)
                .velocityTolerance(8)
