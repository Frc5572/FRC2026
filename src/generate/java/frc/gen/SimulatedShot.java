...
public class SimulatedShot {
     ...
     *        being straight up
     * @param radialVelocity velocity component in the radial direction, with positive values
     *        meaning the robot is moving away from the target
    ...
    private double[] deriv(double[] s) {
        ...
        double kMagnus =
            0.5 * AIR_DENSITY * MAGNUS_COEFF * BALL_AREA_M2 * BALL_RADIUS_M * omega / BALL_MASS_KG;
